...
public class ConsultarRegistroFisicoFORM extends javax.swing.JDialog {
    ...
    /**
     * Creates new form ConsultarRegistroFisicoFORM
     */
    public ConsultarRegistroFisicoFORM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ConsultarRegistroFisicoFORM dialog = new ConsultarRegistroFisicoFORM(new javax.swing.JFrame(), true);
