...
public class IniciarSesionAdministradorFORM extends javax.swing.JDialog {
    ...
    public IniciarSesionAdministradorFORM(java.awt.Frame parent, boolean modal, ControlNavegacion controlNavegacion, ControlRegistroInicioSesion controlInicioSesionRegistro) {
        super(parent, modal);
    ...
    private void btnIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarSesionActionPerformed
        ...
        try {
            ...
            AdministradorDTO administradorDTO = controlInicioSesionRegistro.iniciarSesionAdministrador(correo, contrasenia);

            if (administradorDTO != null && administradorDTO.getId() != null) {
                dispose();
