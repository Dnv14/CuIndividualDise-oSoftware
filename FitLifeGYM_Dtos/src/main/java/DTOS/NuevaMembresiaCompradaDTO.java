...
public class NuevaMembresiaCompradaDTO {
    ...
    public NuevaMembresiaCompradaDTO() {
    }
    ...
    public void setIdMembresiaComprada(String idMembresiaComprada) {
        this.idMembresiaComprada = idMembresiaComprada;
    }
    ...
    public String toString() {
        return "NuevaMembresiaCompradaDTO{" + "idMembresiaComprada=" + idMembresiaComprada + ", membresia=" + membresia + ", fechaInicio=" + fechaInicio + ", fechaFin=" + fechaFin + ", precioPagado=" + precioPagado + ", estado=" + estado + '}';
    }
